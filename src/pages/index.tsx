  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to honefty - Revolutionizing transportation with convenience and efficiency. Find, book, and track your ride in real-time, catering to your diverse needs with a seamless experience."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to honefty - Revolutionizing transportation with convenience and efficiency. Find, book, and track your ride in real-time, catering to your diverse needs with a seamless experience.`}
            </Text>
